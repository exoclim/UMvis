...
map_limits_in(1,0)=-lat_lim    ; Latitude
map_limits_in(1,1)=lat_lim    ; Latitude
...
;plot_grid_use_in(1)=lat_in  ; Latitude
...
plot_limits_in(1,0)=-lat_lim    ; Latitude
plot_limits_in(1,1)=lat_lim     ; Latitude
