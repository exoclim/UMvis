pro vert_meri_region_zonal_temporal_sum, $
   ; Variable List
   variable_list, $
...
map_limits_in(1,0)=lat_min    ; Latitude
map_limits_in(1,1)=lat_max    ; Latitude
map_limits_in(2,0)=vert_low    ; Height/Pressure/Sigma
map_limits_in(2,1)=vert_high    ; Height/Pressure/Sigma
...
plot_limits_in(1,0)=lat_min    ; Latitude
plot_limits_in(1,1)=lat_max     ; Latitude
plot_limits_in(2,0)=vert_low    ; Height/Pressure/Sigma
plot_limits_in(2,1)=vert_high    ; Height/Pressure/Sigma
