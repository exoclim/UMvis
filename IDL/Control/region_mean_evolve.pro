pro region_mean_evolve, $
   ...
   ; Name for the mapped input/output
...
map_limits_in(0,0)=lon_start     ; Longitude
map_limits_in(0,1)=lon_end       ; Longitude
map_limits_in(1,0)=lat_start     ; Latitude
map_limits_in(1,1)=lat_end       ; Latitude
map_limits_in(2,0)=vert_start    ; Height/Pressure/Sigma
map_limits_in(2,1)=vert_end      ; Height/Pressure/Sigma
map_limits_in(3,0)=time_start    ; Time
map_limits_in(3,1)=time_end      ; Time
;-----------------------------------------------------
...
plot_limits_in(0,0)=lon_start   ; Longitude
plot_limits_in(0,1)=lon_end     ; Longitude
plot_limits_in(1,0)=lat_start   ; Latitude
plot_limits_in(1,1)=lat_end     ; Latitude
plot_limits_in(2,0)=vert_start  ; Height/Pressure/Sigma
plot_limits_in(2,1)=vert_end    ; Height/Pressure/Sigma
plot_limits_in(3,0)=time_start  ; Time
plot_limits_in(3,1)=time_end    ; Time
;-----------------------------------------------------
