...
map_limits_in(2,0)=vert_in    ; Height/Pressure/Sigma
map_limits_in(2,1)=vert_in    ; Height/Pressure/Sigma
map_limits_in(3,0)='min'    ; Time
map_limits_in(3,1)='max'      ; Time
;-----------------------------------------------------
...
plot_grid_use_in(2)=vert_in  ; Vertical
...
plot_limits_in(2,0)=vert_in    ; Height/Pressure/Sigma
plot_limits_in(2,1)=vert_in    ; Height/Pressure/Sigma
