...
; Example: using /map_only and netcdf_name=?
; variable_list='Wvel&Horizvel&Temp&Theta....'
; Then using: /from_map_save 
; variable_list='Wvel&Horizvel' or 'Theta&Horizvel' or 'Uvel' etc...
;-----------------------------------------------------
...
plot_grid_use_in(3)='20.5125'  ; Time
;-----------------------------------------------------
