...
SUBROUTINE init_vert_damp(eg_vert_damp_profile,                       &
                             eg_vert_damp_coeff,                      &
                             height_domain, eg_damp_eta_start)
...
REAL,    INTENT(INOUT) :: eg_damp_eta_start
...
CHARACTER*(*),PARAMETER :: RoutineName='EG_INIT_VERT_DAMP'    
INTEGER                 :: ErrorStatus                        
...
REAL    :: eta_s        ! "eta" level at which the damping layer starts
...
INTEGER, PARAMETER :: custom_vert_damp_prof     = 6
...
! Always print out the vertical sponge as we have no other record
IF ( me == 0 ) THEN
